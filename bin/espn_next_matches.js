...
function nexts(url, out){
	xray(url)
		.select([{
			$root: '.mod-container.mod-table.mod-no-header-footer >.mod-content > table',
			date: 'tr:first-child > td',			//date of the matches
			matches: [{			
				$root: 'tr.oddrow,tr.evenrow',
